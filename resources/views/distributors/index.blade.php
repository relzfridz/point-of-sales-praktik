    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('distributors.create') }}"> + buat distributor baru</a>
            </div>
        </div>
    </div>
                ...
                <td>
                    <form action="{{ route('distributors.destroy', $distributor->id) }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-danger"
                            onclick="return confirm('Yakin hapus {{ $distributor->nama_distributor }} ?')">Delete</button>
                    </form>
                </td>
            </tr>
        @endforeach
